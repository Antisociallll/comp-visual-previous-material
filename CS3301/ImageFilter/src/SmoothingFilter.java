...
public class SmoothingFilter extends Frame implements ActionListener {
	...
	public SmoothingFilter(String name) {
		...
		// load image
		try {
			input = ImageIO.read(new File("/Users/Ming/Desktop/CS3301/assign2/baboo.png"));
		}
		catch ( Exception ex ) {
			ex.printStackTrace();
		}
	...
	public static void main(String[] args) {
		new SmoothingFilter(args.length==1 ? args[0] : "/Users/Ming/Documents/workspace/ImageFilter/baboo.png");
	}
}